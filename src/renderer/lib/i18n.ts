...
export const messages = {
  zh: {
    ...
    settings: {
      ...
      refresh: "刷新",
      gameDataUpdated:
        "已更新至版本 {version}：{champions} 名英雄，{augments} 个海克斯强化",
      dataManagement: "数据管理",
      export: "导出数据",
    ...
    analytics: {
      ...
      summary: "{games} 场对局 · 英雄胜率 {winRate}% · {augments} 种海克斯强化",
      baseline: "英雄基准胜率",
      rarity: "品质",
      vsBaseline: "对比基准",
      minPicks: "选取次数",
      augmentCount: "{count} 个海克斯强化",
      noAugments: "暂无符合条件的海克斯强化数据",
      noAllPlayersData: "暂无全场玩家数据。需有包含完整对局详情的记录。",
      patch: "游戏版本",
      allPatches: "全部版本",
      unknownPatch: "未知版本",
      scopeSelf: "我的对局",
      scopeAll: "全场玩家",
      summaryAll: "{games} 次出场 · 胜率 {winRate}% · {augments} 种海克斯强化",
    },
    ...
    global: {
      title: "全局统计",
      summary: "{games} 场 · {champions} 名英雄 · {augments} 个海克斯强化",
      tabChampions: "英雄",
      tabAugments: "海克斯强化",
      championsCount: "{count} 名英雄",
      augmentsCount: "{count} 个海克斯强化",
      searchChampion: "搜索英雄…",
      searchAugment: "搜索海克斯强化…",
      champion: "英雄",
      games: "出场",
      pickRate: "出场率",
      winRate: "胜率",
  ...
  en: {
    ...
    analytics: {
      ...
      noAllPlayersData: "No all-player data yet. Games need full match details stored.",
      patch: "Patch",
      allPatches: "All patches",
      unknownPatch: "Unknown",
      scopeSelf: "My Games",
      scopeAll: "All Players",
      summaryAll: "{games} appearances · {winRate}% WR · {augments} augments",
    },
